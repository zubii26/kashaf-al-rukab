      ...
      <div className="bg-white w-full max-w-[210mm] print:max-w-none print:w-full relative" style={{ minHeight: '297mm', fontFamily: "'Segoe UI', Arial, sans-serif" }}>
        ...
        <div className="p-12 print:p-10 pt-16 print:pt-12" dir="rtl">
          ...
          <div className="mb-8 space-y-2 text-lg">
            <p><span className="font-black text-[#1F2430]">النقل من: </span><span className="font-bold text-[#7d333b] uppercase">{trip.pickup_location}</span></p>
            <p><span className="font-black text-[#1F2430]">وصولا الى: </span><span className="font-bold text-[#7d333b] uppercase">{trip.dropoff_location}</span></p>
            <p><span className="font-black text-[#1F2430]">مدة الرحلة : </span><span className="font-bold text-[#7d333b]">00:00</span></p>
            <p><span className="font-black text-[#1F2430]">سعر الرحلة : </span><span className="font-bold text-[#7d333b]">{trip.price_type === 'deferred' ? 'آجل' : 'نقدي'} ر.س</span></p>
          </div>
